...
class ItemTest < ActiveSupport::TestCase
  ...
  context "Within context" do
    ...
    should "show the three best sold items" do
      assert_equal [["Weighted Chess Pieces", 0], ["Zagreb Chess Pieces", 0], ["Wooden Chess Pieces", 0]] , Item.best_items(3)
    end

    should "show the inventory/reorder levels of the four best sold items" do
      assert_equal [[100, 100, 100, 100], [25, 25, 25, 25], ["Basic Chess Pieces", "Weighted Chess Pieces", "Zagreb Chess Pieces", "Wooden Chess Pieces"]] , Item.best_items_inventory_and_reorder(4)
    end
