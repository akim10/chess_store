...
class UserTest < ActiveSupport::TestCase
  ...
  context "Within context" do
    ...
    should "have a name method that gets the five most frequently orderin customers" do
      assert_equal [["Alex Heimann", 0], ["Mark Heimann", 0], ["Inventory Manager", 0], ["Young Shipper", 0], ["Old Shipper", 0]], User.best_customers
    end
